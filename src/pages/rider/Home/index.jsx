...
const Home = (props) => {
    ...
    const actionButton = (
        <Row justify="center">
            <Col>
                {polling ?
                    <Image src="/stop.png" preview={false} height={"25vh"} width={"25vh"} onClick={() => {
                        riderStop()
                        clearInterval(timer.current)
                        setPolling(false)
                    }} /> :
                    <Image src="/start.png" preview={false} height={"25vh"} width={"25vh"} onClick={async () => {
    ...
    return (
        <PageContainer content={content} extraContent={actionButton}>
                                    ...
                                    <Card.Meta
                                        ...
                                        description={
                                            <>
                                                ...
                                                >
                                                    {[item.creator_address.province + item.creator_address.city + item.creator_address.area + item.creator_address.detail].join(" ")}
                                                </Paragraph>
                                            </>
                                        }
                                    />
            ...
            <Modal title="一笔新订单来啦！" visible={modalVisible} onOk={handleOk} onCancel={handleCancel} cancelText={"取消"} okText={"确认接单"}>
                <Card
                    hoverable
                    className={styles.card}
                    actions={[
                    ...
                    <Card.Meta
                        ...
                        description={
                            <>
                                ...
                                >
                                    {[next?.creator_address.AddressProvince, next?.creator_address.AddressCity, next?.creator_address.AddressArea, next?.creator_address.AddressDetail].join(" ")}
                                </Paragraph>
                            </>
                        }
                    />
